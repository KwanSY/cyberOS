...
林默绝不是因为所谓 [[因工作压力过大情绪失控]] 而自杀！在 2010-06-09 暴雨断网的那天夜里，他在 15 楼机房撞破了副总裁 [[陈建国]] 的致命秘密。

林默在工作站本地目录中留有绝密离线备份文件 [[diary.enc]]。
为了防止被篡改，他设置了对称加密。

根据林默的习惯，备用解密密钥为：
【他在天宇科技的入职年份】+【他的爱犬名字】（全小写无空格拼接，例如：2008kitty）。

你可以在其工作邮箱的 HR 邮件或公司团队介绍中查到入职年份，并在其本地草稿中寻找宠物的名字。解密日记是查明真相的唯一钥匙！`,
  },
...
—— 林默 (安全架构部)`,
  ...
  // 6. 林默垃圾箱：关于情绪与压力的公关通知
  {
    id: 'mail_006',
    sender: 'admin@tianyu-tech.com',
    senderName: '天宇安委会办公室',
    subject: '【内部关切】关于员工心理健康与抗压辅导的通知',
    date: '2010-06-05 11:20',
    folder: 'trash',
    read: true,
    content: `各位同仁：
近期部分研发岗位高强度攻坚，若有同事出现 [[因工作压力过大情绪失控]] 或焦虑倾向，请及时向公司心理咨询室报备，避免发生安全意外。`,
  },
];
...
事发时间：2010-06-09 [[2010-06-09 23:30]] 至 23:45
气象条件：特大暴雨伴随强雷电，23:30 外部主光缆因雷击中断。

监控复核矛盾发现：
虽然门禁系统显示副总裁陈建国已于 [[2010-06-09 23:35]] 从 [[1楼门禁]] 打卡离开；
然而，安防部在调取 [[15楼机房]] 走廊独立供电摄像头录像时，赫然发现：
在 [[2010-06-09 23:38]]，画面抓拍到一名身着深色风衣的男子匆匆刷卡进入 15 楼机房！
经身形与步态多重比对，该风衣男子体态特征与副总裁 [[陈建国]] 完全吻合！
证实 23:35 的 1 楼门禁系 [[伪造1楼门禁打卡记录]]（使用代打卡制造假的不在场证明），陈建国实际上仍在 15 楼作案！曾有人怀疑是否有人 [[违规植入键盘记录木马]]，实则为直接物理侵入机房。`,
  },
];
