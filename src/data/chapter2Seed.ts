...
[[赵岚]]（[[SUB-0007]]）的真实脑电图已经被 [[梁绍辉]] 主任强行销毁，他受财务总监 [[沈明远]] 的指示，正逼迫赵岚家属在 [[强制签署保密与放弃追责协议]] 上签字！

我用录音笔偷录了梁主任在办公室里的谈话，加密保存在附件 [[voicemail_07.enc]] 中。
为了防备 [[梁绍辉]] 拿到录音，我用了我最刻骨铭心的那个日子作为 8 位数字密码——那是我第一次穿上圣路加护士服正式入职宣誓的日子……
...
3. 鉴于管床护士 [[苏曼]] 多次私自调阅归档病历，安保部已对其采取严格行踪布控。`,
  ...
  {
    id: 'page_news_nurse_accident',
    title: '【社会快讯】滨海环城公路发生深夜单方车辆坠海事故，遇难者为圣路加医院护士',
    url: 'http://news.metro-daily.com/local/20100603/traffic-incident-coastal',
    category: 'news',
    author: '都市晨报 突发社会新闻组',
    date: '2010-06-03 08:30',
    summary: '昨日深夜一辆轿车冲破滨海公路护栏坠海，遇难司机确认为圣路加医院在职重症监护护士苏曼。',
    keywords: [
      '苏曼',
      '圣路加第七医院',
      '车祸',
    ...
    contentType: 'article',
    content: `【本市讯】今日凌晨 1 时 40 分许，滨海北路环海立交发生一起严重单方交通事故。
一辆由市区驶往郊区的白色两厢轿车在过弯时突然失控撞断路侧双层防撞护栏，坠入 15 米落差的悬崖海域。

交警与水上搜救部门连夜组织打捞，于清晨 6 时许将遇难车辆及落水人员搜寻出水。经法医现场确认，女性驾驶员已无生命体征。
死者随身工作证件显示，其为 [[圣路加第七医院]] 神经重症监护室在职护士 [[苏曼]]（28岁）。

交警部门初步勘验报告指出，事故现场未发现明显的紧急制动拖印，初步怀疑为“雨夜路滑叠加转向失灵”。但有附近货车司机向媒体透露，事发前曾目击一辆无牌黑色 SUV 紧尾随死者车辆。目前交警重大事故侦查支队已调取沿途卡口监控展开进一步核查。`,
  },
  {
    id: 'page_nurse_shift',
...
================================================================
【苏曼个人私密备忘】
“我偷偷把梁绍辉让我发布的假病历（/med/records/SUB-0007_public.txt）与我私自导出的真实原始脑电记录（/med/backup/SUB-0007_raw_eeg.dat）一并封存进脱机镜像卷中。
只要将这两份档案放在一起对照，那多出来的 40mg 神经毒药剂量和被涂改的放电波形，就是他们谋财害命的铁证……”
================================================================`,
  },
];
